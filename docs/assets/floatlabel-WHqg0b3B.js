...
`,classes:{root:function(e){var t=e.props;return[`p-floatlabel`,{"p-floatlabel-over":t.variant===`over`,"p-floatlabel-on":t.variant===`on`,"p-floatlabel-in":t.variant===`in`}]}}}),b={name:`FloatLabel`,extends:{name:`BaseFloatLabel`,extends:n,props:{variant:{type:String,default:`over`}},style:y,provide:function(){return{$pcFloatLabel:this,$parentInstance:this}}},inheritAttrs:!1};function x(e,n,i,a,c,l){return r(),t(`span`,o({class:e.cx(`root`)},e.ptmi(`root`)),[s(e.$slots,`default`)],16)}b.render=x;export{l as i,v as n,h as r,b as t};