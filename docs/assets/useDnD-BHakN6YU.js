import{Et as e,Lt as t}from"./index-DYV8vTLI.js";import{u as n}from"./vue-flow-core-DjlR2UmZ.js";var r=()=>`dndnode_${crypto.randomUUID()}`,i={draggedType:t(null),isDragOver:t(!1),isDragging:t(!1)},a=t(null);function o(){let{draggedType:t,isDragOver:o,isDragging:s}=i,{addNodes:c,screenToFlowCoordinate:l,onNodesInitialized:u,updateNode:d}=n();e(s,e=>{document.body.style.userSelect=e?`none`:``});function f(e,n){if(e.dataTransfer&&(e.dataTransfer.setData(`application/vueflow`,n),e.dataTransfer.effectAllowed=`move`,e.target instanceof HTMLElement)){let t=e.target,n=t.cloneNode(!0);a.value=`vueflow-drag-image-${Date.now()}-${Math.random().toString(36).substring(2,9)}`,n.id=a.value,n.style.cssText=`
